...
BASE_MODEL="/home/hasin.rehana/models/Qwen2.5-7B-Instruct"
OUT_ROOT="results/hparam_runs_qwen2.5_7b_GRID1_V2"

mkdir -p "$OUT_ROOT"

#nohup ./Hyperparameter_tuning_Qwen2.5-7B-Instruct_Instruct_V2.sh \
#  > nohup_Qwen2.5-7B-Instruct_GRID1.out \
#  2>&1 &
