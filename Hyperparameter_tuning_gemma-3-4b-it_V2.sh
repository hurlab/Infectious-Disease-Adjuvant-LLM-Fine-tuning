...
BASE_MODEL="/home/hasin.rehana/models/gemma-3-4b-it" 
OUT_ROOT="results/hparam_runs_gemma-3-4b-it_GRID1_V2"



mkdir -p "$OUT_ROOT"

#nohup ./Hyperparameter_tuning_gemma-3-4b-it_V2.sh \
#  > nohup_gemma-3-4b-it_GRID1.out \
#  2>&1 &
