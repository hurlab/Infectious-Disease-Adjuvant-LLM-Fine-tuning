...
OUT_ROOT="results/hparam_runs_mistral_7B_instruct_v0.3_GRID1_V2"



mkdir -p "$OUT_ROOT"

#nohup ./Hyperparameter_tuning_Mistral-7B-Instruct-v0.3_V2.sh \
#  > nohup_Mistral-7B-Instruct-v0.3_GRID1.out \
#  2>&1 &
